...
3\. Click **Apply Unmask**. The **Access to Sensitive Data** page on Lazada Datamoat is opened.  
4\. Follow the instructions on the **Access to Sensitive Data** page to obtain access to sensitive data for your application. You can also refer to the [DataMoat documentation](<https://open.lazada.com/apps/doc/doc?nodeId=30420&docId=120738>) for details.

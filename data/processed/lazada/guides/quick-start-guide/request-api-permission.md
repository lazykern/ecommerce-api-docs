...
3\. Click the permission group name to view the APIs that belong to the group. You can also refer to the [API Reference](<https://open.lazada.com/apps/doc/api?path=%2Forder%2Fdocument%2Fawb%2Fhtml%2Fget>) section for detailed introduction of the API groups.  

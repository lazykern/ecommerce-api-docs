...
2\. Click the **Create** button, and the list of APP categories is displayed.  
3\. Read the description of the APP categories and click the **Apply** button of a category for your application.  
4\. Enter your business needs for applying the APP category in the **Reason** field of the **Apply** window.  
5\. (Optional) Attach a document file for the request as needed. The document can be the marketing analysis, business plan, or design of your application.  
